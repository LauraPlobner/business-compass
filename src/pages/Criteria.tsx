...
import { Eye, EyeOff, Pencil, Plus, RotateCcw, Trash2, Undo2 } from "lucide-react";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
  ...
  return (
    <div className="flex-1 min-h-0 overflow-y-auto p-6">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-xl font-bold text-foreground mb-1">Kriterien & Gewichtung</h2>
        <p className="text-sm text-muted-foreground mb-6">
          Diese Einstellungen gelten <span className="font-semibold text-foreground">global für alle Business-Ideen</span>.
